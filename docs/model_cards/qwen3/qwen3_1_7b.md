# Qwen3-1.7B vLLM+MindSpore 推理指南
...
snapshot_download(
    repo_id="MindSpore-Lab/Qwen3-1.7B",
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="vllm_mindspore qwen3 demo")
