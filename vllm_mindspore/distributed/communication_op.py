...
from .parallel_state import (
    ...
    prev_pp_rank,
    get_world_group,
    get_world_rank_from_tp_group_rank,
)
...
def tensor_model_parallel_all_gather(input_: Tensor, dim: int = -1) -> Tensor:
    if get_tensor_model_parallel_world_size() == 1:
        return input_
...
def broadcast_tensor_dict(
    tensor_dict: Optional[Dict[Any, Union[Tensor, Any]]] = None, src: int = 0
):
    ...
